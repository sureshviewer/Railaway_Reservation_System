...
******************************************************************************""")
# \n = used to create a new lines or skip the line given space.
rail_info = """"
...
a=0 # global varaiable
user_details = {1234:['suresh','suri','sklm',9160250894]}
train_details = {'Odisha' : [12345,[[20,2045],[30,1565],[35,600],[45,535]],'wed','cal','kgp'],
                 'Amaravathi': [12121,[[30,1670],[35,1100],[34,634],[40,510]],'mon','cal','kgp'],
                 'konark':[45672,[[23,1675],[34,1243],[45,679],[40,485]],'sun','bhuv','hyd']}
user_bookings ={234567890:[1234,'vimath','odisha',1,'wed']}
...
def confirm_ticket(train_details,train,id,tickets,user_details,coach):
    ...
    if con=='y':
        ...
        pnr =np.random.randint(156543334,956872459) #it generate the pnr number with the help of numpy and random modules.
        ...
        if c=='1ac':
            ...
            train_details[train][1][3][0]=train_details[train][1][3][0]-tickets
            print("remaining tickets : ",train_details[train][1][3][0])
    elif con=='n':
        print("not booked!")
                            ...
                            def check_train_number(train_details,a):
                                ...
                                for i in train_details:
                                    if train_number in train_details[i]:
                                        ...
                                        print("No of seats available in 3AC :", train_details[i][1][2][0])
                                        print("No of seats available in SL :",train_details[i][1][3][0])
                                        train = i
                                        def check_coach(train_details,train):
                                            ...
                                            if coach=='1ac':
                                                ...
                                                print("You have to pay : ",(train_details[train][1][3][1])*tickets)
                                                confirm_ticket(train_details,train,id,tickets,user_details,coach)
                                            else : 
                    ...
                    if pass_word==user_details[id][1]:
                        ...
                        if pnr_numer in user_bookings:
                            ...
                            if cancel=='y': 
                                ...
                                print("Money will refund in 3 days :)")
                            else:
                                print("Not canceled !")
                        else:
        ...
        def check_user_id(user_details):
            ...
            if id in user_details:
                def check_password(user_details):
                    ...
                    if pass_word==user_details[id][1]:
                        print("Welcome ",user_details[id][0],"!")
                        print("Village: ",user_details[id][2])
